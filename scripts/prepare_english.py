...
if __name__ == "__main__":
    ...
    input_file = os.path.abspath("../data/en-source/grammar/001_dny_v_tydnu.csv")  
    output_file = os.path.abspath("../data/en-source/grammar/001_dny_v_tydnu_DONE.csv")
    mp3_folder = os.path.abspath("../data/en-source/grammar/001/mp3")
    opus_folder = os.path.abspath("../data/en-source/grammar/001/opus")
